...
block: function(){
pug_html = pug_html + "\u003Cdiv class=\"d-flex justify-content-between flex-wrap\" ld=\"list\"\u003E\u003Cdiv class=\"item rounded border bg-light my-2 p-4\" ld-each=\"item\"\u003E\u003Cdiv class=\"title\" ld=\"title\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"desc\" ld=\"description\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"p-2 bg-dark text-white\" ld-each=\"tag\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
}, "ldview");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
pug_mixins["script"]("/assets/lib/@loadingio/ldquery/main/index.min.js");
pug_mixins["script"]("/assets/lib/ldview/dev/index.js");
pug_html = pug_html + "\u003Cscript type=\"module\"\u003E(function(t){return t.apply({})})(function(){var t,n,e;t={time:(new Date).toLocaleString()};n=[10,11,12,13,14,15].map(function(t){return{title:\"title \"+t,description:Math.random().toString(36).substring(2),list:[2,3].map(function(){return Math.ceil(10*Math.random())})}});return e=new ldView({ctx:t,root:\"[ld-scope=ldview]\",handler:{item:{list:function(){return n},view:{handler:{title:function(t){var n,e,r;n=t.node,e=t.ctx,r=t.ctxs;return n.innerText=e.title},description:function(t){var n,e,r;n=t.node,e=t.ctx,r=t.ctxs;return n.innerText=e.description},tag:{list:function(t){var n;n=t.ctx;return n.list},text:function(t){var n;n=t.data;return n}}}}}}})});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
